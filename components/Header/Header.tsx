        ...
        <div className='container mx-auto'>
            <header className="grid grid-cols-3 items-center p-[1rem] border-b border-[#e5e5e5]">
                ...
                <div className="flex items-center justify-end gap-[2rem]">
                    <svg
                        className="w-[1.5rem] h-[1.5rem] text-black md:w-[2rem] md:h-[2rem] cursor-pointer"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                    ...
                    >
                        <path
                            ...
                            strokeWidth={2}
                            d="M12 14c4.418 0 8 3.582 8 8H4c0-4.418 3.582-8 8-8zm0-8a4 4 0 11-.001 8.001A4 4 0 0112 6z"
                        />
                    </svg>
                </div>
            </header>
